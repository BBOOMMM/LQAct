...
access_token = "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"  # Replace with your actual token
...
def main(
    ...
    lora_weights: str = "./output/lora-alpaca" ,# "RaccoonOnion/Llama-2-7b-hf-LoRA-alpaca-cleaned-rank8", # another option "RaccoonOnion/Llama-2-7b-hf-LoRA-alpaca-cleaned-rank1"
