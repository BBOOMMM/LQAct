...
from ...ops.checkpoint import CheckpointFunction, CheckpointFunction_LowrankPlusQuantization
...
def checkpoint_lowrank_plus_quantization(
    function: Callable,
    self: nn.Module,
    hidden_states: Tensor,
    *args,
    ...
    **kwargs,
    ...
    return CheckpointFunction_LowrankPlusQuantization.apply(
        function,
        self,
        hidden_states,
        preserve_rng_state,
