...
# _, rank_dict = get_vit_rank_ratio(model, dataset["train"], batch_size=512, patch_locations=2)
project_matrixes  = get_vit_project_matrix(model, dataset["train"], batch_size=512, patch_locations=2, base_ratio=1.0/8.0)
